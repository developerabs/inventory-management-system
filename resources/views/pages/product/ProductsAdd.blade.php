    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <form action="{{ route('products.store') }}" method="POST" role="form" id="quickForm">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="supplier_id" style="width: 100%;">
                                        <option selected="selected" disabled>Select Supplier Name</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="unite_id" style="width: 100%;">
                                        <option selected="selected" disabled>Select Unite Name</option>
