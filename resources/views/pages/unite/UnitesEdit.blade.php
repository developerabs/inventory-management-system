        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3>Edit Unites 
                        <a href="{{ route('unites.view') }}" class="btn btn-sm btn-success float-right">Unites</a>
                    </h3>
                </div>
                @if ($errors->any())
                    <div class="alert alert-danger">Something want wrong !</div>
                @endif
                <form action="{{ route('unites.update',$editData->id) }}" method="POST"  id="quickForm2">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
