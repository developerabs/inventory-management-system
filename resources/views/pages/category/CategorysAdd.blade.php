        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3>Add Category 
                        <a href="{{ route('categorys.view') }}" class="btn btn-sm btn-success float-right">Category List</a>
                    </h3>
                </div>
                @if ($errors->any())
                    <div class="alert alert-danger">Something want wrong !</div>
                @endif
                <form action="{{ route('categorys.store') }}" method="POST" role="form" id="quickForm">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
